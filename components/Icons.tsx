...
// Using simple SVG icons to avoid external dependencies for this specific file setup if preferred, 
// but using lucide-react via generic SVG paths is cleaner for "no external npm install" instructions if strict.
// However, the prompt allows popular libraries. I will implement SVG components directly for zero-dep simplicity.
